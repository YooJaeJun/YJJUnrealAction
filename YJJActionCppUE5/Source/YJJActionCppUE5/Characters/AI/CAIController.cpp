...
{
	YJJHelpers::GetAsset(&BBAsset, "/Script/AIModule.BlackboardData'/Game/Character/Enemies/CBB_Enemy.CBB_Enemy'");
	YJJHelpers::GetAsset(&BTAsset, "/Script/AIModule.BehaviorTree'/Game/Character/Enemies/Melee/CBT_Melee.CBT_Melee'");
