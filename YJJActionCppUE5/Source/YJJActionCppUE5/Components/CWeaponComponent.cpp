...
void UCWeaponComponent::SetMode(CEWeaponType InType)
{
	...
	const TObjectPtr<UCWeaponAsset>* assetForCheckingNull = DataAssetMap.Find(InType);
...
TWeakObjectPtr<UCWeaponAsset> UCWeaponComponent::GetWeaponAsset()
{
	...
	const TObjectPtr<UCWeaponAsset>* assetForCheckingNull = DataAssetMap.Find(Type);
