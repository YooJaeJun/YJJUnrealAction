...
void ACAnimal::OnStateTypeChanged(const CEStateType InPrevType, const CEStateType InNewType)
{
	switch (InNewType)
	{
...
void ACAnimal::OnHitStateTypeChanged(const CEHitType InPrevType, const CEHitType InNewType)
{
	Hit();
}

USpringArmComponent* ACAnimal::GetSpringArm() const
{
	return SpringArm;
}

UCTargetingComponent* ACAnimal::GetTargetingComp() const
{
