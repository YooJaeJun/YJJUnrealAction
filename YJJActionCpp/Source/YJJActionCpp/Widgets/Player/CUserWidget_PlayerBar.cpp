...
void UCUserWidget_PlayerBar::BindHpStat(UCCharacterStatComponent* InNewStat)
{
	CheckNull(InNewStat);
...
void UCUserWidget_PlayerBar::BindStaminaStat(UCCharacterStatComponent* InNewStat)
{
	CheckNull(InNewStat);
...
void UCUserWidget_PlayerBar::BindManaStat(UCCharacterStatComponent* InNewStat)
{
	CheckNull(InNewStat);
