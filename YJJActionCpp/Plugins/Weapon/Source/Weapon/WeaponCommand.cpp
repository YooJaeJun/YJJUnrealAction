...
void FWeaponCommand::Startup()
{
	...
	const FToolBarExtensionDelegate toolbar = 
		FToolBarExtensionDelegate::CreateRaw(this, &FWeaponCommand::AddToolBar);
...
void FWeaponCommand::AddToolBar(FToolBarBuilder& InBuilder) const
{
	...
	InBuilder.AddToolBarButton(
		...
		FText::FromString("Weapon Asset Editor"), 
		FWeaponStyle::Get()->ToolBar_Icon, 
		NAME_None);
}
